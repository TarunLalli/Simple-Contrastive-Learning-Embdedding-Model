...
This study acts as an exploration into the affect of contrastive learning on the embdedding space. Evaluation of the work consists of a visual analysis of the embedding space using t-SNE.
